...
# --- VIEW 1: THE SPLASH SCREEN (Home Portal) ---
if st.session_state.page == "home":
    ...
    with col2:
        ...
        st.write("Access the secure patient queue and appointment dashboard.")
        # Doctor Login space is right here on the splash page
...
# --- VIEW 2: THE DIAGNOSTICS APP ---
    ...
    # Sidebar back button to return to Splash Screen
        ...
        with loading_placeholder.container():
            st.markdown("""
                <div style="padding: 30px; text-align: center;">
                    ...
                    <p style="color: #444; font-weight: 500;">AI is cross-referencing symptom patterns...</p>
                </div>
            """, unsafe_allow_html=True)
            time.sleep(2.5)
